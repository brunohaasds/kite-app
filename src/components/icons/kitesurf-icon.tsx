...
type KitesurfIconProps = {
  className?: string;
};

/** Ícone kitesurf (SVG); usa `currentColor` para alinhar a Lucide em tema claro/escuro. */
export function KitesurfIcon({ className }: KitesurfIconProps) {
  return (
    <svg
