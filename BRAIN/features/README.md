...
| [LANDING_PUBLICA_SPOT_ESCOLA.md](./LANDING_PUBLICA_SPOT_ESCOLA.md) | Páginas públicas `/spot/[slug]` e `/escola/[orgSlug]`: hero, parceiros |
| [BUILD_DEPLOY_VERCEL.md](./BUILD_DEPLOY_VERCEL.md) | `postinstall` Prisma, build na Vercel, variáveis |
| [PRODUTO_PLACEHOLDERS.md](./PRODUTO_PLACEHOLDERS.md) | Reset por email, avaliações na conta, notificações — roadmap e estado |
